...
{
    public partial class VibrationSTFT : Form
    {
        public VibrationSTFT()
        {
            InitializeComponent();
        }
        double[,] result;
        ...
        private void STFT_Load(object sender, EventArgs e)
        {
            try
            {
               
                data = DataTempStorage.TempVibrationData1;

                result = DigitalSignalProcessing.NiSignalProcessing.STFT(data, DataTempStorage.TempVibrationSampleFrequency1, "海明窗", 256, 20, 0, data.Length - 1, false, out Time, out Frequency);
